...
where $\Delta B$ is the variation in the holding field, $\gamma \Delta B$, the dominant term, is a spread in Larmor frequencies $\Delta \omega$, which causes spin-spin dephasing in a characteristic time of $1/\Delta \omega$. 

The time evolution of the nuclear magnetization {\bf M} is described by the Bloch equation~\cite{PhysRev.70.460}:
