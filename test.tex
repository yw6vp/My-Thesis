...
See in Table~\ref{table:Xtable}.

\begin{figure}[H]
	\label{XvsT}
	\centering
	\resizebox{0.91\textwidth}{!}{\includegraphics{XvsT.png}}
	\caption{{Shown are the combined values for X factor (either $X_12$ or $X_1234$ depending on the availability of data) versus temperature for the cell Sosa, Simone and Antoinette.}}
\end{figure}
